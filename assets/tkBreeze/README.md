...
* Breeze version was created by MaxPerl: [https://github.com/MaxPerl/ttk-Breeze](https://github.com/MaxPerl/ttk-Breeze)

Changes:

* Names of directories
* Small bugfixes
* Changed font to the default Tk font: -font "Helvetica 10" \ -> -font TkDefaultFont \
...
1. If you want to use both, set your environment variable *TCLLIBPATH* to
...
2. If you want to use only one of themes: set your environment variable
...
3. Edit (or create) your *.Xresources* file and add line:
   * If you want to use Breeze theme: `*TkTheme:breeze`
   * If you want to use Breeze dark theme: `*TkTheme:breeze-dark`
4. Reload your Xorg configuration with command: `xrdb -merge ~/.Xresources`